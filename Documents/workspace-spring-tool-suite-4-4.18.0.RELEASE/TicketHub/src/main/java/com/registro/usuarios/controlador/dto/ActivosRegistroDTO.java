...
public class ActivosRegistroDTO {
	...
	public ActivosRegistroDTO(Long id, Integer cedulaEstudiante, String nombreEstudiante, String apellidoEstudiante,
	...
	public ActivosRegistroDTO(Integer cedulaEstudiante, String nombreEstudiante, String apellidoEstudiante,
			String usernameEstudiante, String facultadEstudiante, String descripcionEquipo, String categoriaEquipo, String referenciaEquipo,
			String serialEquipo, Boolean estado) {
		super();
		this.cedulaEstudiante = cedulaEstudiante;
	...
	public ActivosRegistroDTO(String usernameEstudiante) {
		super();
		this.usernameEstudiante = usernameEstudiante;
	}

	public ActivosRegistroDTO() {
		super();
	}
